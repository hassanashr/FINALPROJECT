...
constexpr auto qt_meta_stringdata_CLASSsettingsENDCLASS = QtMocHelpers::stringData(
    ...
    "map_design",
    "on_back_clicked",
    "on_map_design_clicked",
    "on_sound_valueChanged",
    "value"
);
...
Q_CONSTINIT const QMetaObject settings::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSsettingsENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_map_design_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_sound_valueChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void settings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->map_design(); break;
        case 2: _t->on_back_clicked(); break;
        case 3: _t->on_map_design_clicked(); break;
        case 4: _t->on_sound_valueChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &settings::back; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (settings::*)();
            if (_t _q_method = &settings::map_design; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
