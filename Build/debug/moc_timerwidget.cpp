...
struct qt_meta_stringdata_CLASSTimerWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSTimerWidgetENDCLASS = QtMocHelpers::stringData(
    "TimerWidget",
    "updateTime",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTimerWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject TimerWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSTimerWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTimerWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTimerWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *TimerWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTimerWidgetENDCLASS.stringdata0))
