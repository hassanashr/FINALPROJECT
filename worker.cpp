...
void Worker::returnHome()
{
    destination->setX(xHome);
    destination->setY(yHome);
...
void Worker::movePath()
{
    ...
    if(ln.length() < 20 && doneHealing){
        structToFix->parent->removeItem(this);
